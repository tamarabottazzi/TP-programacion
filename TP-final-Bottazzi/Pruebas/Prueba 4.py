...
# Prueba 4: 
    ...
    # 5) mide el tiempo que tarda en hacer en exportar al archivo
...
elapsed_time_dic = end_time_dic - start_time_dic
...
print(f"Tiempo de ejecución de armado de tabla: {elapsed_time_dic:.5f} segundos")
print(f"Tiempo de ejecución de exportación a archivo: {elapsed_time:.5f} segundos")
